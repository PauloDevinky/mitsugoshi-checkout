-- ============================================
-- CORRIGIR RLS DE TODAS AS TABELAS
-- ============================================
-- Este script garante que admins possam acessar todas as tabelas necessárias
-- ============================================
...
-- Política: Qualquer pessoa pode ver produtos (para checkout público)
CREATE POLICY "Products are viewable by everyone"
ON public.products
FOR SELECT
USING (true);

-- Política: Admins podem criar, atualizar e deletar produtos
...
-- Política alternativa: Se não quiser restringir, permitir tudo para autenticados
...
-- Política: Admins podem ver e atualizar transações
...
-- Política alternativa: Autenticados podem ver e atualizar
...
-- Política: Admins podem ver leads
...
-- Política alternativa: Autenticados podem ver
...
SELECT 
    ...
    roles
FROM pg_policies
WHERE tablename IN ('products', 'transactions', 'leads')
ORDER BY tablename, policyname;

-- ✅ Agora todas as tabelas devem estar acessíveis!
