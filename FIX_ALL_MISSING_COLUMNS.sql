-- ============================================
-- ADICIONAR TODAS AS COLUNAS FALTANTES DO CHECKOUT BUILDER
-- ============================================
...
BEGIN
  ...
  IF EXISTS (
    ...
    WHERE conname LIKE '%checkout_security_badges_type%'
  ) THEN
    ALTER TABLE public.products 
    DROP CONSTRAINT IF EXISTS products_checkout_security_badges_type_check;
  END IF;
...
-- ✅ Se todas as 10 colunas aparecerem na query acima, tudo foi criado com sucesso!
-- Se alguma coluna não aparecer, execute novamente o ALTER TABLE acima.
